...
public class RoomInfoServiceImpl extends ServiceImpl<RoomInfoMapper, RoomInfo>
    ...
    @Autowired
    RoomInfoMapper roomInfoMapper; //idea显示问题不用管

    @Autowired
    ApartmentInfoMapper apartmentInfoMapper;//idea显示问题不用管
    @Autowired
    GraphInfoMapper graphInfoMapper;//idea显示问题不用管
    @Autowired
    AttrValueMapper attrValueMapper;//idea显示问题不用管
    @Autowired
    FacilityInfoMapper facilityInfoMapper;//idea显示问题不用管
    @Autowired
    LabelInfoMapper labelInfoMapper;//idea显示问题不用管
    @Autowired
    PaymentTypeMapper paymentTypeMapper;//idea显示问题不用管
    @Autowired
    LeaseTermMapper leaseTermMapper;//idea显示问题不用管
    @Autowired

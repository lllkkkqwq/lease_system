...
@Configuration
public class WebMvcConfiguration implements WebMvcConfigurer {//WebMvcConfigurer中不同方法用于完成不同配置

//   @Autowired
//    private StringToItemTypeConverter stringToItemTypeConverter;//可废弃
   ...
   private StringToBaseEnumConverterFactory stringToBaseEnumConverterFactory;
    ...
    @Override//注册自定义converter需要是实现的是addFormatters方法
    public void addFormatters(FormatterRegistry registry) {

//        registry.addConverter(this.stringToItemTypeConverter);//可废弃
